  ...
  return (
    <div className="flex gap-8 w-full flex-wrap  justify-center py-10 px-20 min-h-[40vh]">
      <div
        ...
        className="flex flex-col gap-2 items-center shadow-lg border-2 hover:scale-95 transition-all cursor-pointer  w-fit bg-white p-3 rounded-md"
      >
        <img
      ...
      <div
        ...
        className="flex flex-col items-center gap-2 shadow-lg border-2 hover:scale-95 transition-all cursor-pointer  w-fit bg-white p-3 rounded-md"
      >
        <img
      ...
      <div
        ...
        className="flex flex-col gap-2 items-center shadow-md border-2 hover:scale-95 transition-all cursor-pointer  w-fit bg-white p-3 rounded-md"
      >
        <img
